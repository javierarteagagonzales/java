...
class LaminaSpinner extends JPanel {
	...
	public LaminaSpinner() {
		...
		/*opcional centro texto spinner
		 * control3.setPreferredSize(new Dimension(100,20));
		((JSpinner.DefaultEditor)control3.getEditor()).getTextField().setHorizontalAlignment(JTextField.CENTER);
		*/
		add(control3);
	}
